...
class AnimatedPlaceHolderTextField: UITextField {
    ...
    func Initialize() {
        ...
        self.addTarget(self, action: #selector(AnimatedPlaceHolderTextField.textFieldDidChange), for: .editingChanged)
        self.EnableMaterialPlaceHolder(enableMaterialPlaceHolder: true)
        self.borderStyle = .none
        self.placeHolderColor = UIColor(red: 181/255.0, green: 171/255.0, blue: 171/255.0, alpha: 1.0)
